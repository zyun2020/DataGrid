    ...
    public partial class DataGrid
    {
        ...
        private bool ComputeDisplayedColumns()
        {
            ...
            if (displayWidth <= 0 || this.ColumnsInternal.VisibleColumnCount == 0)
            {
                ...
                this.DisplayData.LastDisplayedScrollingCol = -1;
                return invalidate;
            }
            ...
            if (cx < displayWidth && firstDisplayedScrollingCol >= 0)
            {
                ...
                if (dataGridColumn.IsFrozen)
                {
                    ...
                    if (dataGridColumn == null)
                    {
                        this.DisplayData.FirstDisplayedScrollingCol = this.DisplayData.LastDisplayedScrollingCol = -1;
                        return invalidate;
                    }
                    else
                    {
                ...
                {
                    this.DisplayData.LastDisplayedScrollingCol = -1; // no totally visible scrolling column at all
                }
                else
                {
                    DiagnosticsDebug.Assert(firstDisplayedScrollingCol >= 0, "Expected positive firstDisplayedScrollingCol.");
                    ...
                    this.DisplayData.LastDisplayedScrollingCol = dataGridColumn.Index;
                }
            }
            else
            {
