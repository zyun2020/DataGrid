...
namespace CommunityToolkit.WinUI.SampleApp.Data
{
    ...
    public class DataGridDataSource
    {
        ...
        public async Task<ObservableCollection<DataGridDataItem>> GetDataAsyncEx()
        {
            var lines = await File.ReadAllLinesAsync(Path.Combine(Package.Current.InstalledLocation.Path, @"Assets/mtns.csv"));
